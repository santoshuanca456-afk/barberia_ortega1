            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ol class="breadcrumb justify-content-center">
                        ...
                        <li class="breadcrumb-item active">Pago Exitoso</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="section">
        <div class="container">
            <div class="alert alert-default text-center">
                ...
                <p>¡Gracias por tu pedido, {{ $order->customer->name }}!</p>
                <p>Tu número de pedido es <strong>#{{ $order->order_no }}</strong>.</p>
                <p>Se ha enviado un correo de confirmación a {{ $order->customer->email }}.</p>
                <p>Si tienes alguna pregunta, por favor contáctanos al 
